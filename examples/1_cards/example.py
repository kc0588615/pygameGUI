...
#Update Imports: Now, in your examples/3_integrated/example.py file, change your import statements to reflect the new locations:
#from common.cards.card import Card  # If you want to import specific things
#from common.cards.card_controller import CardController
#from common.cards.animated_background import AnimatedBackground
...
# Define asset paths relative to the current script
...
try:
    from common.assets.fonts import M5X7
    print("M5X7 imported successfully:", M5X7)
except ImportError as e:
    print("Import error:", str(e))
    print("Trying to find common package...")
    for path in sys.path:
        if os.path.exists(os.path.join(path, 'common')):
            print("Found common package at:", os.path.join(path, 'common'))
